...
** 除了 iSCSI 之外，还增加了对ONTAP ASA r2 的 NVMe/TCP 支持。看link:link:https://docs.netapp.com/us-en/trident/trident-use/ontap-san-examples.html["ONTAP SAN配置选项和示例"^]。
...
* 修复了使用SolidFire后端克隆卷时出现的超时问题（link:https://github.com/NetApp/trident/issues/1008["问题描述#1008"] ）。
