...
* *本地 ONTAP* - Trident 支持基于 NFSv3 的 Kerberos 加密以及从 Red Hat OpenShift 和上游 Kubernetes 集群到本地 ONTAP 卷的连接。
...
* 请确保您使用 Kerberos 加密的所有卷都配置正确。请参阅 https://www.netapp.com/media/16398-tr-3580.pdf["NetApp 增强功能和最佳实践指南"^]的 NetApp 域配置部分（第 13 页）。
