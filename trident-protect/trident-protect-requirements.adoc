...
如果您计划将虚拟机与SnapMirror复制结合使用 https://kubevirt.io/["KubeVirt"^]、则需要设置虚拟化、以便可以冻结和取消冻结SVM。设置虚拟化后、您部署的SVM将包括冻结和取消冻结所需的工具。要了解有关设置虚拟化的详细信息，请参见 https://docs.openshift.com/container-platform/4.17/virt/install/installing-virt.html["安装OpenShift虚拟化"^]。
