...
* 确保至少存在一个 VolumeSnapshotClass。有关详细信息，请参阅 link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotClass"]。
...
----
====
要了解如何使用 Trident Protect 定义应用程序和还原虚拟机，请参见 link:trident-protect-kubevirt-vms.html["使用 Trident Protect 保护 KubeVirt 虚拟机"]。
